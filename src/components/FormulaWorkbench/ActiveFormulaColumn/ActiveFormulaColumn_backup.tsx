  ...
  const dropdownMenuItems: DropdownMenuOption[] = [
    {
      ...
      icon: "warning",
      iconColor: "secondary",
      action: () => {}, // TODO: Validate formula against IFRA/allergens/brand rules.
    },
    {
      id: "yielding",
      label: "Set Yield",
      icon: "calculator",
      iconColor: "secondary",
      action: () => {}, // TODO: Scale weights to a target batch (keeps ratios).
    },
    {
      id: "round-off",
      label: "Round Weights",
      icon: "calculator",
      iconColor: "secondary",
      action: () => {}, // TODO: Apply rounding (e.g., 0.1 g) to amounts only.
    },
    {
      id: "normalization",
      ...
      icon: "balanceScale",
      iconColor: "secondary",
      action: () => {}, // TODO: Re-proportion unlocked rows to hit 100% or a target mass.
    },
    {
      id: "create-version",
      ...
      icon: "copy",
      iconColor: "secondary",
      action: () => {}, // TODO: Create a new version with current values.
    },
    { type: "separator" },
    {
      id: "undo-last",
      ...
      action: canUndo && onUndo ? onUndo : () => {}, // Revert your last change.
      disabled: !canUndo,
    },
    {
      id: "add-ingredient",
                          ...
                          try {
                            ...
                            return (
                              ...
                              >
                                ...
                                <TableCell
                                  title={`Cost: €${(ingredient.ingredient?.costPerKg || (ingredient.ingredient?.costPerKg ? ingredient.ingredient.costPerKg * 1000 : 0) || 0).toFixed(2)} per kg`}
                                >
                                  €
                                  {(
                                    ingredient.ingredient?.costPerKg ||
                                    (ingredient.ingredient?.costPerKg
                                      ? ingredient.ingredient.costPerKg * 1000
                                      : 0) ||
                                    0
                                  ).toFixed(2)}
                                </TableCell>
                  ...
                  if (item.isMissing) {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell
                          title={`Cost: €${(formulaIngredient.ingredient.costPerKg || formulaIngredient.ingredient.costPerKg * 1000 || 0).toFixed(2)} per kg`}
                        >
                          €
                          {(
                            formulaIngredient.ingredient.costPerKg ||
                            formulaIngredient.ingredient.costPerKg * 1000 ||
                            0
                          ).toFixed(2)}
                        </TableCell>
                        <TableCell
